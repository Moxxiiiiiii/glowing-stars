...
func _on_wylatt_1_pressed() -> void:
	...
	“If you’re asking if she’s my birth mother, yes she is.”[/center] 
	
He laughs a little at the question, taken aback but doesn’t seem otherwise offended by it

[center]“I never met dad, but I’m told he was pretty extraordinary. A real adventurous type! But, it’s all stories from me, you’d be better off asking her about it sometime.”[/center]
...
func _on_wylatt_2_pressed() -> void:
	%"context-text".text = ""
	var storyVar1 = '[center][i]His expression looks a little pained, and you’re not quite sure why.[/i][/center]
	
[center][img]res://addons/sprites/Wylatt-1.png[/img]

“I suppose so. Things were a little shakey when I was little, something to do with dad. But for the most part, things have been the same. Nothing really changes here.”[/center] 

He shrugs his slender shoulders, taking another bite of the food while it’s still warm. Something’s bothering him, but doesn’t look like he’s ready to talk about it.'
	%"context-text".append_text(str(storyVar1))


func _on_wylatt_3_pressed() -> void:
	%"context-text".text = ""
	var storyVar1 = '[center][i]His cheeks flush a light shade of pink, giggling a little as he scratches the back of his head pondering how best to phrase what’s on his mind.[/i][/center]

[center][img]res://addons/sprites/Wylatt-1.png[/img]

“I take it the Zaphkiel Hub had stores like this too, but basically we sell sexual wellness products, along with a variety of other novelty toys and equipment to keep things fresh between folks. Quite a fun job, but the stacking of shelves is as boring as any other retail front.”[/center]

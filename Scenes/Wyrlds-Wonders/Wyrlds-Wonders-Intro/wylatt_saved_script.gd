...
func display_credits_choice():
	%"context-text".text = ""
	var storyvar1 = '[center][img]res://addons/sprites/Wylatt-1.png
	
“You want half?!”[/center]

The pale femboy’s eyes widen, taken aback by your request.

[center]“I don’t want to come off rude.. But that’s a little steep don’t you think? How about.. 20%?”[/center]

Given you did help but didn’t do half his job, you reason that’s fair, a greedy smirk on your lip.

[center]“Well.. Thank you anyways. I do appreciate it. You should probably take this package out to Wyrld, I’m sure she’s looking for it.”[/center]'
...
“Ah, but… Surely there’s something you’d like?”[/center]

Wylatt is a little confused by your response, but a slight smirk crawls up his lip.

[center]“Well, you did help me so… I’ll find a way to pay you back! Meet me at the Gym later, and I’ll have something prepared for you okay?”[/center]
...
[center]“Oh! Don’t go leaving without this. Kinda… The whole reason I ended up there. Heh..”[/center]
...
func display_help_choice():
	%"context-text".text = ""
	var storyText1 = '[center][i]Wylatt’s deep blue eyes widen, cheeks flushed with embarrasment. He eyes up your {playerStature} figure, narrowing eagerly as they wonder over your hips before returning his gaze back to yours. It’s hard not to feel a little objectified, but it’s not like you didn’t ask for it.[/i]

[img]res://addons/sprites/Wylatt-1.png[/img]

“I… I can probabaly help you out with that. We’ll have to be quick though, Wyrld might get mad if we waste too much time.”

[i]A mix of desire and nerves twist his face a little, biting his lower lip as he struggles to keep eye contact.[/i]

“So…. How are we gonna do this, {playerName}?[/center]
...
[++ 50 Lust]'
	...
	%"context-text".append_text(str(storyText3))

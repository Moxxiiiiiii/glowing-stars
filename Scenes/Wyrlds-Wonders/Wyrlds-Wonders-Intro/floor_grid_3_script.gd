...
“All done back there, and based off of pre-renovation numbers we’ll have enough stock for at least a month.”[/center]
...
“Of course Mom, you can count on me for sure! But I’m sure you already knew that~”[/center]

You let Wyrld know that you’ll help out when you can too, and she thanks you both once again.

[center][img]res://addons/sprites/Wyrld-1.png[/img]

“Now, enough dilly dallying, there’s still daylight! Go enjoy your days and be home by nightfall ‘kay? I got some calls to make still so I’ll be here if y’ need anything, ‘kay cuties?”[/center]

You both nod, waving her off. Wylatt heads for the door first,

[center][img]res://addons/sprites/Wylatt-1.png[/img]

“I’ll be at the Gym if you need me okay, {playerName}? See you both later!”[/center]
